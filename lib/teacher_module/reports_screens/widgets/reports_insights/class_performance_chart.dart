// lib/presentation/widgets/reports_insights/class_performance_chart.dart
...
class ClassPerformanceChart extends StatelessWidget {
  ...
  const ClassPerformanceChart({super.key, required this.performanceData});
  ...
  Widget build(BuildContext context) {
    ...
    if (performanceData == null ||
      ...
      return SizedBox(
        ...
        child: const Center(child: Text("Performance data not available.")),
      );
    }
                    ...
                    getTitlesWidget: (value, meta) {
                      ...
                      if (index >= 0 && index < subjects.length) {
                        return SideTitleWidget(
                          space: ScreenUtilHelper.height(8),
                          meta: meta,
                          child: Text(subjects[index], style: AppStyles.chartLabel.copyWith(fontSize: ScreenUtilHelper.fontSize(12))),
                        );
                      }
                      return const Text('');
                    },
                ...
                leftTitles: AxisTitles(
                  sideTitles: SideTitles(
                    ...
                    getTitlesWidget: (value, meta) => Text(
                      ...
                      style: AppStyles.chartLabel.copyWith(fontSize: ScreenUtilHelper.fontSize(12)),
                    ),
                  ...
                  getTooltipItems: (List<LineBarSpot> touchedBarSpots) {
                    return touchedBarSpots.map((barSpot) {
                      ...
                      return LineTooltipItem(
                        ...
                        AppStyles.lineTooltip(
                          flSpot.bar.gradient?.colors.first ?? flSpot.bar.color ?? AppColors.white,
                        ),
                      );
                    }).toList();
                  },
    ...
    return LineChartBarData(
      ...
      dotData: FlDotData(
        ...
        getDotPainter: (spot, percent, barData, index) => FlDotCirclePainter(
          radius: ScreenUtilHelper.radius(4),
          color: color,
          strokeWidth: 1,
  ...
  Widget _buildLegendItem(Color color, String text) {
    return Row(
      ...
      children: [
        ...
        Text(text, style: AppStyles.font12.copyWith(fontSize: ScreenUtilHelper.fontSize(12))),
      ],
    );
  }
}
