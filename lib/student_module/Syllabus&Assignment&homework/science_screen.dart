...
import 'custom/chapterDropdown.dart'; // Adjust the path as needed

class ScienceDetails extends StatelessWidget {
  const ScienceDetails({super.key});

  @override
  Widget build(BuildContext context) {
    // return Scaffold(
    //   appBar: AppBar(
    //     leadingWidth: ScreenUtilHelper.scaleWidth(110), // ✅ responsive width
    //     leading: Row(
