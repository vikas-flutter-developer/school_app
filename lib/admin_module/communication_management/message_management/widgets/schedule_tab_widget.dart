...
class _ScheduleTabWidgetState extends State<ScheduleTabWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        context.read<MessageBloc>().add(const RecipientTypeChanged('All'));
      }
    });
  }
              ...
              Center(
                child: GestureDetector(
                  onTap: () async {
                    ...
                    if (picked != null) {
                      context.read<MessageBloc>().add(DateChanged(picked));
                    }
                  },
                  child: Container(
              ...
              Center(
                child: GestureDetector(
                  onTap: () async {
                    ...
                    if (picked != null) {
                      context.read<MessageBloc>().add(TimeChanged(picked));
                    }
                  },
                  child: Container(
                    width: ScreenUtilHelper.width(306),
                ...
                child: Column(
                  children: [
                    ...
                    TextField(
                      ...
                      onChanged: (value) {
                        context.read<MessageBloc>().add(MessageChanged(value));
                      },
                      maxLines: 6,
                      decoration: InputDecoration(
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    context.read<MessageBloc>().add(const ScheduleMessage());
                  },
  ...
  Widget _buildRecipientTypeDropdown(BuildContext context, MessageState state) {
    return SizedBox(
      ...
      child: DropdownButtonFormField<String>(
        ...
        icon: Icon(Icons.keyboard_arrow_down, color: AppColors.ash, size: ScreenUtilHelper.fontSize(24)),
        isExpanded: true,
    ...
    return Row(
      ...
      children: [
        Radio<String>(
          ...
          onChanged: (newValue) {
            context.read<MessageBloc>().add(SendViaChanged(newValue!));
          },
        ...
        GestureDetector(
          onTap: () {
            context.read<MessageBloc>().add(SendViaChanged(value));
          },
          child: Text(
            value,
            style: TextStyle(
  ...
  // --- Formatting Toolbar Widgets (Added to resolve errors) ---
